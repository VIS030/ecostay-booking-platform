      ...
      <div className="mx-auto flex max-w-[1040px] flex-col md:flex-row">
        ...
        <div className="flex flex-1 items-center justify-center px-6 py-12">
          <div className="w-full max-w-[400px]">
            <h1 className="text-2xl font-semibold text-[#222222]">Finish signing up</h1>
            <form onSubmit={handleSubmit} className="mt-8 space-y-4">
              ...
              <Button type="submit" className="w-full" size="lg" loading={loading}>Agree and continue</Button>
            </form>
            <p className="mt-6 text-center text-sm text-[#717171]">
              Already have an account? <Link to="/login" className="font-semibold text-[#222222] underline">Log in</Link>
            </p>
          </div>
        </div>
      </div>
