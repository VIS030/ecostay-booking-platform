      ...
      <div className="mx-auto flex max-w-[1040px] flex-col md:flex-row">
        ...
        <div className="flex flex-1 items-center justify-center px-6 py-12">
          <div className="w-full max-w-[400px]">
            <h1 className="text-2xl font-semibold text-[#222222]">Welcome to EcoStay</h1>
            ...
            <p className="mt-6 text-center text-sm text-[#717171]">
              New to EcoStay? <Link to="/register" className="font-semibold text-[#222222] underline">Create an account</Link>
            </p>
          </div>
        </div>
      </div>
